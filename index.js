...
Elm.Github = Elm.Github || {};
Elm.Github.make = function (_elm) {
   "use strict";
   _elm.Github = _elm.Github || {};
   if (_elm.Github.values) return _elm.Github.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var title = Elm.Native.Port.make(_elm).outbound("title",function (v) {    return v;},"Get your total github stars");
   var init = {ctor: "_Tuple2",_0: {input: "",stars: 0},_1: $Effects.none};
   var inputStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "40vw"}
                                                   ,{ctor: "_Tuple2",_0: "height",_1: "15vh"}
                                                   ,{ctor: "_Tuple2",_0: "fontSize",_1: "4vw"}
                                                   ,{ctor: "_Tuple2",_0: "textAlign",_1: "center"}
                                                   ,{ctor: "_Tuple2",_0: "fontWeight",_1: "300"}]));
   ...
   var containerStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"}
                                                       ...
                                                       ,{ctor: "_Tuple2",_0: "textAlign",_1: "center"}
                                                       ,{ctor: "_Tuple2",_0: "fontFamily",_1: "\'Helvetica Neue\', Helvetica, Arial, sans-serif"}
                                                       ,{ctor: "_Tuple2",_0: "flexDirection",_1: "column"}]));
   var is13 = function (key) {    return _U.eq(key,13) ? $Result.Ok({ctor: "_Tuple0"}) : $Result.Err("incorrect keyCode");};
   ...
   var totalStars = function (list) {    return $List.sum(A2($List.map,function (_) {    return _.stargazers_count;},list));};
   var httpString = function (user) {    return A2($Basics._op["++"],"https://api.github.com/users/",A2($Basics._op["++"],user,"/repos?per_page=100"));};
   var Stargazers = function (a) {    return {stargazers_count: a};};
   var decodeResult = $Json$Decode.list(A2($Json$Decode.object1,Stargazers,A2($Json$Decode._op[":="],"stargazers_count",$Json$Decode.$int)));
   var httpTask = function (user) {    return A2($Http.get,decodeResult,httpString(user));};
   var OnSubmit = function (a) {    return {ctor: "OnSubmit",_0: a};};
   ...
   var update = F2(function (action,model) {
      ...
      {case "KeyPress": return {ctor: "_Tuple2",_0: _U.update(model,{input: _p2._0}),_1: $Effects.none};
         ...
         case "OnSubmit": return {ctor: "_Tuple2"
                                 ,_0: A2(Model,model.input,A2($Maybe.withDefault,0,$Result.toMaybe(A2($Result.map,totalStars,_p2._0))))
                                 ,_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: model,_1: $Effects.none};}
   });
   var app = $StartApp.start({init: init,inputs: _U.list([]),update: update,view: view});
   var main = app.html;
   var fetch = Elm.Native.Task.make(_elm).performSignal("fetch",app.tasks);
   return _elm.Github.values = {_op: _op
                               ,Model: Model
                               ,NoOp: NoOp
                               ,KeyPress: KeyPress
                               ,Submit: Submit
